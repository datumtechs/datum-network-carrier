...
func (syncQueue *SyncProposalStateMonitorQueue) CheckMonitors(now int64, asyncCall bool) int64 {
...
func (syncQueue *SyncProposalStateMonitorQueue) runMonitor(now int64, asyncCall bool) int64 {
