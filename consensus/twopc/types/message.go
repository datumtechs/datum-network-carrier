...
type OrgProposalState struct {
	...
	taskSender       *libcommonpb.TaskOrganization
	taskOrg          *libcommonpb.TaskOrganization
...
func (pstate *OrgProposalState) GetTaskRole() libcommonpb.TaskRole { return pstate.taskRole }
func (pstate *OrgProposalState) GetTaskSender() *libcommonpb.TaskOrganization {
	return pstate.taskSender
}
func (pstate *OrgProposalState) GetTaskOrg() *libcommonpb.TaskOrganization { return pstate.taskOrg }
...
func (psm *ProposalStateMonitor) GetTaskSender() *libcommonpb.TaskOrganization { return psm.sender }
