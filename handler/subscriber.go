...
import (
	"context"
	"fmt"
	"github.com/datumtechs/datum-network-carrier/common/messagehandler"
...
func (s *Service) registerSubscribers() {
	...
	s.subscribe(
		p2p.TaskTerminateMsgTopicFormat,
		s.validateTaskTerminateMessagePubSub,
		s.taskTerminateMessageSubscriber,
	)
}
