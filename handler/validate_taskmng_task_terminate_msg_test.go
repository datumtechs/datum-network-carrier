...
func TestValidateTwopc_ValidTaskTerminate(t *testing.T) {
	...
	valid := r.validateTaskTerminateMessagePubSub(ctx, "foobar", msg) == pubsub.ValidationIgnore
