...
func (m *GetGlobalMetadataDetail) GetOwner() *common.Organization {
	if m != nil {
		return m.Owner
	}
	return nil
...
func (m *GetLocalMetadataDetail) GetOwner() *common.Organization {
	if m != nil {
		return m.Owner
	}
	return nil
...
var fileDescriptor_ac620a9256b640e4 = []byte{
	...
	,
}
