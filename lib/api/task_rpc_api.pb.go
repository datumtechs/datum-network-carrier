...
type TaskMetadataDeclare struct {
	...
	IndexColumn          uint32   `protobuf:"varint,2,opt,name=index_column,json=indexColumn,proto3" json:"index_column,omitempty"`
	CaculateColumns      []uint32 `protobuf:"varint,3,rep,packed,name=caculate_columns,json=caculateColumns,proto3" json:"caculate_columns,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *TaskMetadataDeclare) GetIndexColumn() uint32 {
	if m != nil {
		return m.IndexColumn
	}
	return 0
}

func (m *TaskMetadataDeclare) GetCaculateColumns() []uint32 {
	if m != nil {
		return m.CaculateColumns
	}
	return nil
}
...
var fileDescriptor_7a744901dce4e8cd = []byte{
	...
	,
}
...
func (m *TaskMetadataDeclare) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CaculateColumns) > 0 {
		dAtA15 := make([]byte, len(m.CaculateColumns)*10)
		var j14 int
		for _, num := range m.CaculateColumns {
			for num >= 1<<7 {
	...
	if m.IndexColumn != 0 {
		i = encodeVarintTaskRpcApi(dAtA, i, uint64(m.IndexColumn))
		i--
		dAtA[i] = 0x10
	}
	if len(m.MetadataId) > 0 {
...
func (m *TaskMetadataDeclare) Size() (n int) {
	...
	if m.IndexColumn != 0 {
		n += 1 + sovTaskRpcApi(uint64(m.IndexColumn))
	}
	if len(m.CaculateColumns) > 0 {
		l = 0
		for _, e := range m.CaculateColumns {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IndexColumn |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType == 0 {
				...
				m.CaculateColumns = append(m.CaculateColumns, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.CaculateColumns) == 0 {
					m.CaculateColumns = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field CaculateColumns", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipTaskRpcApi(dAtA[iNdEx:])
