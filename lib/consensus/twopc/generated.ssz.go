...
// Hash: de8be7356c0369f4f9c2d2845f9be6eb1e1c9124ba7e0c3b6e4768054b5a2091
package twopc
...
func (p *PrepareMsg) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if p.TaskOption == nil {
		p.TaskOption = new(TaskOption)
	}
	offset += p.TaskOption.SizeSSZ()
	...
	// Field (1) 'TaskOption'
	if dst, err = p.TaskOption.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (p *PrepareMsg) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'TaskOption'
	{
		...
		if err = p.TaskOption.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
...
func (p *PrepareMsg) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (1) 'TaskOption'
	if err = p.TaskOption.HashTreeRootWith(hh); err != nil {
		return
	}
...
// MarshalSSZ ssz marshals the TaskOption object
func (t *TaskOption) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(t)
}

// MarshalSSZTo ssz marshals the TaskOption object to a target array
func (t *TaskOption) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(80)
	...
	// Offset (4) 'AlgoSupplier'
	dst = ssz.WriteOffset(dst, offset)
	if t.AlgoSupplier == nil {
		t.AlgoSupplier = new(TaskOrganizationIdentityInfo)
	}
	offset += t.AlgoSupplier.SizeSSZ()

	// Offset (5) 'DataSupplier'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(t.DataSupplier); ii++ {
		offset += 4
		offset += t.DataSupplier[ii].SizeSSZ()
	}

	// Offset (6) 'PowerSupplier'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(t.PowerSupplier); ii++ {
		offset += 4
		offset += t.PowerSupplier[ii].SizeSSZ()
	}

	// Offset (7) 'Receivers'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(t.Receivers); ii++ {
		offset += 4
		offset += t.Receivers[ii].SizeSSZ()
	}

	// Field (8) 'OperationCost'
	if t.OperationCost == nil {
		t.OperationCost = new(TaskOperationCost)
	}
	if dst, err = t.OperationCost.MarshalSSZTo(dst); err != nil {
		return
	}

	// Offset (9) 'CalculateContractCode'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(t.CalculateContractCode)

	// Offset (10) 'DatasplitContractCode'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(t.DatasplitContractCode)
	...
	// Field (2) 'TaskName'
	if len(t.TaskName) > 64 {
		err = ssz.ErrBytesLength
		return
	}
	dst = append(dst, t.TaskName...)
	...
	// Field (4) 'AlgoSupplier'
	if dst, err = t.AlgoSupplier.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (5) 'DataSupplier'
	if len(t.DataSupplier) > 16777216 {
		err = ssz.ErrListTooBig
		return
	}
	{
		offset = 4 * len(t.DataSupplier)
		for ii := 0; ii < len(t.DataSupplier); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += t.DataSupplier[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(t.DataSupplier); ii++ {
		if dst, err = t.DataSupplier[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}

	// Field (6) 'PowerSupplier'
	if len(t.PowerSupplier) > 16777216 {
		err = ssz.ErrListTooBig
		return
	}
	{
		offset = 4 * len(t.PowerSupplier)
		for ii := 0; ii < len(t.PowerSupplier); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += t.PowerSupplier[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(t.PowerSupplier); ii++ {
		if dst, err = t.PowerSupplier[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}

	// Field (7) 'Receivers'
	if len(t.Receivers) > 16777216 {
		err = ssz.ErrListTooBig
		return
	}
	{
		offset = 4 * len(t.Receivers)
		for ii := 0; ii < len(t.Receivers); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += t.Receivers[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(t.Receivers); ii++ {
		if dst, err = t.Receivers[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}

	// Field (9) 'CalculateContractCode'
	if len(t.CalculateContractCode) > 16777216 {
		err = ssz.ErrBytesLength
		return
	}
	dst = append(dst, t.CalculateContractCode...)

	// Field (10) 'DatasplitContractCode'
	if len(t.DatasplitContractCode) > 16777216 {
		err = ssz.ErrBytesLength
		return
	}
	dst = append(dst, t.DatasplitContractCode...)

	return
}

// UnmarshalSSZ ssz unmarshals the TaskOption object
func (t *TaskOption) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 80 {
		return ssz.ErrSize
	...
	tail := buf
	var o0, o1, o2, o3, o4, o5, o6, o7, o9, o10 uint64
	...
	// Offset (6) 'PowerSupplier'
	if o6 = ssz.ReadOffset(buf[24:28]); o6 > size || o5 > o6 {
		return ssz.ErrOffset
	}

	// Offset (7) 'Receivers'
	if o7 = ssz.ReadOffset(buf[28:32]); o7 > size || o6 > o7 {
		return ssz.ErrOffset
	}
	...
	if err = t.OperationCost.UnmarshalSSZ(buf[32:64]); err != nil {
		return err
	}

	// Offset (9) 'CalculateContractCode'
	if o9 = ssz.ReadOffset(buf[64:68]); o9 > size || o7 > o9 {
		return ssz.ErrOffset
	}

	// Offset (10) 'DatasplitContractCode'
	if o10 = ssz.ReadOffset(buf[68:72]); o10 > size || o9 > o10 {
		return ssz.ErrOffset
	}
	...
	// Field (2) 'TaskName'
	{
		...
		if cap(t.TaskName) == 0 {
			t.TaskName = make([]byte, 0, len(buf))
		}
		t.TaskName = append(t.TaskName, buf...)
	}
	...
	// Field (4) 'AlgoSupplier'
	{
		...
		if err = t.AlgoSupplier.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	// Field (5) 'DataSupplier'
	{
		...
		t.DataSupplier = make([]*DataSupplierOption, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if t.DataSupplier[indx] == nil {
				t.DataSupplier[indx] = new(DataSupplierOption)
			}
			if err = t.DataSupplier[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
	...
	// Field (6) 'PowerSupplier'
	{
		...
		t.PowerSupplier = make([]*PowerSupplierOption, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if t.PowerSupplier[indx] == nil {
				t.PowerSupplier[indx] = new(PowerSupplierOption)
			}
			if err = t.PowerSupplier[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
	...
	// Field (7) 'Receivers'
	{
		...
		t.Receivers = make([]*ReceiverOption, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if t.Receivers[indx] == nil {
				t.Receivers[indx] = new(ReceiverOption)
			}
			if err = t.Receivers[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
	...
	// Field (9) 'CalculateContractCode'
	{
		...
		if cap(t.CalculateContractCode) == 0 {
			t.CalculateContractCode = make([]byte, 0, len(buf))
		}
		t.CalculateContractCode = append(t.CalculateContractCode, buf...)
	}
	...
	// Field (10) 'DatasplitContractCode'
	{
		...
		if cap(t.DatasplitContractCode) == 0 {
			t.DatasplitContractCode = make([]byte, 0, len(buf))
		}
		t.DatasplitContractCode = append(t.DatasplitContractCode, buf...)
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the TaskOption object
func (t *TaskOption) SizeSSZ() (size int) {
	size = 80
	...
	size += t.AlgoSupplier.SizeSSZ()

	// Field (5) 'DataSupplier'
	for ii := 0; ii < len(t.DataSupplier); ii++ {
		size += 4
		size += t.DataSupplier[ii].SizeSSZ()
	}

	// Field (6) 'PowerSupplier'
	for ii := 0; ii < len(t.PowerSupplier); ii++ {
		size += 4
		size += t.PowerSupplier[ii].SizeSSZ()
	}

	// Field (7) 'Receivers'
	for ii := 0; ii < len(t.Receivers); ii++ {
		size += 4
		size += t.Receivers[ii].SizeSSZ()
	}

	// Field (9) 'CalculateContractCode'
	size += len(t.CalculateContractCode)

	// Field (10) 'DatasplitContractCode'
	size += len(t.DatasplitContractCode)

	return
}

// HashTreeRoot ssz hashes the TaskOption object
func (t *TaskOption) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(t)
}

// HashTreeRootWith ssz hashes the TaskOption object with a hasher
func (t *TaskOption) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (4) 'AlgoSupplier'
	if err = t.AlgoSupplier.HashTreeRootWith(hh); err != nil {
		return
	}
	...
	{
		subIndx := hh.Index()
		num := uint64(len(t.DataSupplier))
		if num > 16777216 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for i := uint64(0); i < num; i++ {
			if err = t.DataSupplier[i].HashTreeRootWith(hh); err != nil {
				return
			}
		}
	...
	{
		subIndx := hh.Index()
		num := uint64(len(t.PowerSupplier))
		if num > 16777216 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for i := uint64(0); i < num; i++ {
			if err = t.PowerSupplier[i].HashTreeRootWith(hh); err != nil {
				return
			}
		}
		hh.MerkleizeWithMixin(subIndx, num, 16777216)
	...
	{
		subIndx := hh.Index()
		num := uint64(len(t.Receivers))
		if num > 16777216 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for i := uint64(0); i < num; i++ {
			if err = t.Receivers[i].HashTreeRootWith(hh); err != nil {
				return
			}
		}
		hh.MerkleizeWithMixin(subIndx, num, 16777216)
	...
	// Field (8) 'OperationCost'
	if err = t.OperationCost.HashTreeRootWith(hh); err != nil {
		return
	}
	...
	hh.PutBytes(t.CalculateContractCode)
	...
	hh.PutBytes(t.DatasplitContractCode)
...
func (c *ConfirmMsg) UnmarshalSSZ(buf []byte) error {
	...
	// Field (5) 'CreateAt'
	c.CreateAt = ssz.UnmarshallUint64(buf[24:32])

	// Offset (6) 'Sign'
	if o6 = ssz.ReadOffset(buf[32:36]); o6 > size || o4 > o6 {
		return ssz.ErrOffset
	}
...
func (c *ConfirmVote) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'Epoch'
	c.Epoch = ssz.UnmarshallUint64(buf[4:12])
