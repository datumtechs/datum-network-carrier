...
type MsgOption struct {
	...
	SenderRole           []byte                        `protobuf:"bytes,2,opt,name=sender_role,json=senderRole,proto3" json:"sender_role,omitempty" ssz-max:"32"`
	...
	ReceiverRole         []byte                        `protobuf:"bytes,4,opt,name=receiver_role,json=receiverRole,proto3" json:"receiver_role,omitempty" ssz-max:"32"`
...
func (m *MsgOption) GetSenderRole() []byte {
	if m != nil {
		return m.SenderRole
	}
	return nil
...
func (m *MsgOption) GetReceiverRole() []byte {
	if m != nil {
...
var fileDescriptor_a59cdf46cb297048 = []byte{
	...
	,
}
...
func (m *MsgOption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ReceiverRole) > 0 {
		i -= len(m.ReceiverRole)
		copy(dAtA[i:], m.ReceiverRole)
		i = encodeVarintMessage(dAtA, i, uint64(len(m.ReceiverRole)))
		i--
		dAtA[i] = 0x22
	}
	...
	if len(m.SenderRole) > 0 {
		i -= len(m.SenderRole)
		copy(dAtA[i:], m.SenderRole)
		i = encodeVarintMessage(dAtA, i, uint64(len(m.SenderRole)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *MsgOption) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.SenderRole = append(m.SenderRole[:0], dAtA[iNdEx:postIndex]...)
			if m.SenderRole == nil {
				m.SenderRole = []byte{}
			}
			iNdEx = postIndex
		...
		case 4:
			...
			m.ReceiverRole = append(m.ReceiverRole[:0], dAtA[iNdEx:postIndex]...)
