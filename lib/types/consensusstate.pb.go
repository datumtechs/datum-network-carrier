...
type OrgProposalState struct {
	...
	CreateAt             uint64                   `protobuf:"varint,3,opt,name=create_at,json=createAt,proto3" json:"create_at,omitempty"`
	TaskRole             common.TaskRole          `protobuf:"varint,4,opt,name=task_role,json=taskRole,proto3,enum=api.protobuf.TaskRole" json:"task_role,omitempty"`
	TaskOrg              *common.TaskOrganization `protobuf:"bytes,5,opt,name=task_org,json=taskOrg,proto3" json:"task_org,omitempty"`
	...
	TaskSender           *common.TaskOrganization `protobuf:"bytes,8,opt,name=task_sender,json=taskSender,proto3" json:"task_sender,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
var fileDescriptor_63bd441fc0a440d7 = []byte{
	...
	,
}
