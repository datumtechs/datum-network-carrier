...
type OrgProposalState struct {
	...
	CreateAt             uint64            `protobuf:"varint,3,opt,name=create_at,json=createAt,proto3" json:"create_at,omitempty"`
	TaskRole             TaskRole          `protobuf:"varint,4,opt,name=task_role,json=taskRole,proto3,enum=types.TaskRole" json:"task_role,omitempty"`
...
type MsgOption struct {
	ProposalId           string            `protobuf:"bytes,1,opt,name=proposal_id,json=proposalId,proto3" json:"proposal_id,omitempty"`
	SenderRole           TaskRole          `protobuf:"varint,2,opt,name=sender_role,json=senderRole,proto3,enum=types.TaskRole" json:"sender_role,omitempty"`
	SenderPartyId        string            `protobuf:"bytes,3,opt,name=sender_party_id,json=senderPartyId,proto3" json:"sender_party_id,omitempty"`
	ReceiverRole         TaskRole          `protobuf:"varint,4,opt,name=receiver_role,json=receiverRole,proto3,enum=types.TaskRole" json:"receiver_role,omitempty"`
...
var fileDescriptor_63bd441fc0a440d7 = []byte{
	...
	,
}
