...
type ResourcePB struct {
	...
	PublishAt            uint64   `protobuf:"varint,16,opt,name=publish_at,json=publishAt,proto3" json:"publish_at,omitempty"`
	UpdateAt             uint64   `protobuf:"varint,17,opt,name=update_at,json=updateAt,proto3" json:"update_at,omitempty"`
...
func (m *ResourcePB) GetDataStatus() common.DataStatus {
	if m != nil {
		return m.DataStatus
	}
...
func (m *ResourcePB) GetState() common.PowerState {
	if m != nil {
		return m.State
	}
...
func (m *LocalResourcePB) GetDataStatus() common.DataStatus {
	if m != nil {
		return m.DataStatus
	}
	return common.DataStatus_DataStatus_Unknown
...
func (m *LocalResourcePB) GetState() common.PowerState {
	if m != nil {
		return m.State
	}
	return common.PowerState_PowerState_Unknown
...
var fileDescriptor_8efe43321c6120dd = []byte{
	...
	,
}
...
func (m *ResourcePB) Size() (n int) {
	...
	if m.PublishAt != 0 {
		n += 2 + sovResourcedata(uint64(m.PublishAt))
	}
	if m.UpdateAt != 0 {
