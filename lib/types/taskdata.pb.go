...
type TaskDetail struct {
	...
	TaskEvents           []*TaskEvent                    `protobuf:"bytes,16,rep,name=task_events,json=taskEvents,proto3" json:"task_events,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                        `json:"-"`
	XXX_unrecognized     []byte                          `json:"-"`
	XXX_sizecache        int32                           `json:"-"`
}
...
func (m *TaskDetail) GetTaskEvents() []*TaskEvent {
	if m != nil {
		return m.TaskEvents
	}
	return nil
...
type TaskDataSupplier struct {
	...
	Columns              []*MetadataColumn        `protobuf:"bytes,4,rep,name=columns,proto3" json:"columns,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (m *TaskDataSupplier) GetColumns() []*MetadataColumn {
	if m != nil {
		return m.Columns
	}
	return nil
...
var fileDescriptor_2293d9334aae6da1 = []byte{
	...
	,
}
...
func (m *TaskDataSupplier) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Columns = append(m.Columns, &MetadataColumn{})
