...
import (
	...
	"github.com/datumtechs/datum-network-carrier/common/sliceutil"
	...
	"github.com/datumtechs/datum-network-carrier/node/registration"
	"github.com/datumtechs/datum-network-carrier/p2p"
	"github.com/datumtechs/datum-network-carrier/rpc"
	"github.com/datumtechs/datum-network-carrier/rpc/backend"
	rpcdebug "github.com/datumtechs/datum-network-carrier/rpc/debug"
...
func (node *CarrierNode) registerHandlerService() error {
	...
	node.fetchP2P().AddBlackList(node.fetchBlackList())
