...
type EstimateTaskGasRequest struct {
	...
	TokenItems           []string `protobuf:"bytes,2,rep,name=token_items,json=tokenItems,proto3" json:"token_items,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *EstimateTaskGasRequest) GetTokenItems() []string {
	if m != nil {
		return m.TokenItems
	}
	return nil
...
type TokenItem struct {
	TokenType            constant.TokenType `protobuf:"varint,1,opt,name=token_type,json=tokenType,proto3,enum=common.constant.TokenType" json:"token_type,omitempty"`
...
func (m *TokenItem) Reset()         { *m = TokenItem{} }
func (m *TokenItem) String() string { return proto.CompactTextString(m) }
func (*TokenItem) ProtoMessage()    {}
func (*TokenItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b7e00091afb5ca8, []int{10}
}
func (m *TokenItem) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TokenItem) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TokenItem.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TokenItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TokenItem.Merge(m, src)
}
func (m *TokenItem) XXX_Size() int {
	return m.Size()
}
func (m *TokenItem) XXX_DiscardUnknown() {
	xxx_messageInfo_TokenItem.DiscardUnknown(m)
}

var xxx_messageInfo_TokenItem proto.InternalMessageInfo

func (m *TokenItem) GetTokenType() constant.TokenType {
	if m != nil {
		return m.TokenType
	}
	return constant.TokenType_ERC20
}

func (m *TokenItem) GetTokenAddress() string {
	if m != nil {
...
func (m *TokenItem) GetValue() uint64 {
	if m != nil {
		return m.Value
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*TokenItem)(nil), "carrier.api.TokenItem")
...
var fileDescriptor_1b7e00091afb5ca8 = []byte{
	...
	,
}
...
func (m *EstimateTaskGasRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TokenItems) > 0 {
		for iNdEx := len(m.TokenItems) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TokenItems[iNdEx])
			copy(dAtA[i:], m.TokenItems[iNdEx])
			i = encodeVarintTaskRpcApi(dAtA, i, uint64(len(m.TokenItems[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *TokenItem) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TokenItem) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TokenItem) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.TokenAddress) > 0 {
		...
		i = encodeVarintTaskRpcApi(dAtA, i, uint64(len(m.TokenAddress)))
		i--
		dAtA[i] = 0x12
	}
	if m.TokenType != 0 {
		i = encodeVarintTaskRpcApi(dAtA, i, uint64(m.TokenType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *TokenItem) Size() (n int) {
	...
	_ = l
	if m.TokenType != 0 {
		n += 1 + sovTaskRpcApi(uint64(m.TokenType))
	}
...
func (m *EstimateTaskGasRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TokenItems", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TokenItems = append(m.TokenItems, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTaskRpcApi(dAtA[iNdEx:])
...
func (m *TokenItem) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TokenItem: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TokenItem: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TokenType |= constant.TokenType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
