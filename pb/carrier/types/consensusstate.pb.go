...
type OrgProposalState struct {
	...
	CreateAt             uint64            `protobuf:"varint,3,opt,name=create_at,json=createAt,proto3" json:"create_at,omitempty"`
	TaskRole             constant.TaskRole `protobuf:"varint,4,opt,name=task_role,json=taskRole,proto3,enum=common.constant.TaskRole" json:"task_role,omitempty"`
...
func (m *OrgProposalState) GetTaskRole() constant.TaskRole {
	if m != nil {
		return m.TaskRole
	}
...
type MsgOption struct {
	ProposalId           string            `protobuf:"bytes,1,opt,name=proposal_id,json=proposalId,proto3" json:"proposal_id,omitempty"`
	SenderRole           constant.TaskRole `protobuf:"varint,2,opt,name=sender_role,json=senderRole,proto3,enum=common.constant.TaskRole" json:"sender_role,omitempty"`
	SenderPartyId        string            `protobuf:"bytes,3,opt,name=sender_party_id,json=senderPartyId,proto3" json:"sender_party_id,omitempty"`
	ReceiverRole         constant.TaskRole `protobuf:"varint,4,opt,name=receiver_role,json=receiverRole,proto3,enum=common.constant.TaskRole" json:"receiver_role,omitempty"`
...
func (m *MsgOption) GetSenderRole() constant.TaskRole {
	if m != nil {
		return m.SenderRole
	}
	return constant.TaskRole_TaskRole_Unknown
...
func (m *MsgOption) GetReceiverRole() constant.TaskRole {
	if m != nil {
...
var fileDescriptor_aefd563c87ad898c = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TaskRole |= constant.TaskRole(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SenderRole |= constant.TaskRole(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReceiverRole |= constant.TaskRole(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
