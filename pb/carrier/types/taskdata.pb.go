...
type TaskPB struct {
	...
	State                    TaskState                  `protobuf:"varint,25,opt,name=state,proto3,enum=carrier.types.TaskState" json:"state,omitempty"`
...
type TaskDetailSummary struct {
	...
	UserType                 UserType                   `protobuf:"varint,4,opt,name=user_type,json=userType,proto3,enum=carrier.types.UserType" json:"user_type,omitempty"`
	...
	State                    TaskState                  `protobuf:"varint,23,opt,name=state,proto3,enum=carrier.types.TaskState" json:"state,omitempty"`
...
var fileDescriptor_e931f05aaeb6ecda = []byte{
	...
	,
}
