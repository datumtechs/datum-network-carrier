...
var (
	...
	ErrSendPowerMsgByNidAndPowerId   = &backend.RpcBizErr{Code: 12005, Msg: "Failed to send powerMsg"}
	...
	ErrSendPowerRevokeMsgByPowerId   = &backend.RpcBizErr{Code: 12009, Msg: "Failed to send powerRevokeMsg"}
)
