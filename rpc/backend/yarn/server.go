...
var (
	...
	ErrGetRegisterNodeListForReportUpFileSummary         = &backend.RpcBizErr{Code: 14021, Msg: "ReportUpFileSummary failed, call GetRegisterNodeList() failed, req.GetOriginId: {%s}, req.GetFilePath: {%s}, req.Ip: {%s}, req.Port: {%s}"}
	...
	ErrGetRegisterNodeListForReportTaskResultFileSummary = &backend.RpcBizErr{Code: 14028, Msg: "ReportTaskResultFileSummary failed, call GetRegisterNodeList() failed, req.TaskId: {%s}, req.GetOriginId: {%s}, req.GetFilePath: {%s}, req.Ip: {%s}, req.Port: {%s}"}
	...
	ErrGetDataNodeInfoForQueryAvailableDataNode          = &backend.RpcBizErr{Code: 14031, Msg: "QueryAvailableDataNode failed, call GetRegisterNode() failed, fileType: {%s}, fileSize: {%d}, dataNodeId: {%s}"}
	ErrGetDataNodeInfoForQueryFilePosition               = &backend.RpcBizErr{Code: 14032, Msg: "QueryFilePosition failed, call GetRegisterNode() failed, originId: {%s}, dataNodeId: {%s}"}
